...
export default function BlogDetailPage({ params }: { params: { id: string } }) {
    ...
    // In a real app, you would fetch the blog post based on params.id
    // const { id } = params
                        ...
                        <article className="space-y-8">
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="space-y-4">
                                    ...
                                    <h1 className="text-4xl leading-tight font-bold">{blogPost.title}</h1>
                                ...
                                <CardContent className="p-6">
                                    <div className="flex items-center space-x-4">
                                        ...
                                        <div className="flex-1">
                                            <h4 className="text-lg font-semibold mb-1">{blogPost.author}</h4>
                        ...
                        <Card>
                            ...
                            <CardContent className="space-y-4">
                                {relatedPosts.map((post) => (
                                    <div key={post.id} className="space-y-2 p-3 rounded-lg hover:bg-accent cursor-pointer transition-colors" onClick={() => router.push(`/blog/${post.id}`)}>
                        ...
                        <Card className="bg-gradient-to-br from-blue-50 to-purple-50 dark:from-blue-900/20 dark:to-purple-900/20">
                            ...
                            <CardContent className="space-y-4">
                                ...
                                <input
                                    ...
                                    className="w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 bg-background"
                                />
