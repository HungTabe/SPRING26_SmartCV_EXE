            ...
            <div className="container px-4 mx-auto py-6">
                ...
                <div className="grid lg:grid-cols-3 gap-8 mb-12">
                    <div className="lg:col-span-2 space-y-6">
                        <div className="space-y-4">
                            ...
                            <h1 className="text-4xl font-bold">Hướng Dẫn Phỏng Vấn Thành Công</h1>
                    ...
                    <div className="space-y-6">
                                ...
                                <div className="aspect-video bg-gray-100 rounded-lg mb-4 relative overflow-hidden group cursor-pointer">
                                    ...
                                    <div className="absolute inset-0 bg-black/20 flex items-center justify-center group-hover:bg-black/30 transition-colors">
                                        <div className="w-16 h-16 bg-white/90 rounded-full flex items-center justify-center shadow-lg transform group-hover:scale-110 transition-transform">
                                            <PlayCircle className="w-8 h-8 text-green-600 ml-1" />
                                        </div>
                                    </div>
                                </div>
                        ...
                        <Card className="bg-gradient-to-br from-green-50 to-blue-50 dark:from-green-950/20 dark:to-blue-950/20">
                            <CardHeader>
                                <CardTitle className="text-lg text-green-800 dark:text-green-400">Thống Kê Thành Công</CardTitle>
                            </CardHeader>
                            <CardContent className="space-y-4">
                                <div className="text-center">
                                    <div className="text-3xl text-green-600 dark:text-green-400 font-bold mb-1">92%</div>
                                    <p className="text-sm text-green-700 dark:text-green-300">Nhận được offer</p>
                                </div>
                                <div className="text-center">
                                    <div className="text-3xl text-blue-600 dark:text-blue-400 font-bold mb-1">4.2x</div>
                                    <p className="text-sm text-blue-700 dark:text-blue-300">Tăng cơ hội được chọn</p>
                                </div>
                            </CardContent>
                        </Card>
                    </div>
                ...
                <Tabs defaultValue="modules" className="w-full">
                                    ...
                                    <CardContent className="p-6">
                                        <div className="flex items-start space-x-4">
                                            <div className="bg-green-100 dark:bg-green-900/30 p-3 rounded-lg flex-shrink-0">
                                                <module.icon className="w-6 h-6 text-green-600 dark:text-green-400" />
                                            </div>
                                            <div className="flex-1">
                                                ...
                                                <div className="space-y-3 mb-4">
                                                    {module.topics.map((topic, index) => (
                                                        <div key={index} className="flex items-start space-x-3 text-sm">
                                                            <div className={`w-5 h-5 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5 ${index < module.completed ? 'bg-green-500 text-white' : 'bg-gray-200 dark:bg-gray-700'
                                                                }`}>
                                                ...
                                                <div className="flex flex-col sm:flex-row items-center justify-between gap-4 pt-4 border-t border-border">
                                                    <div className="flex items-center space-x-4 text-sm text-muted-foreground w-full sm:w-auto justify-between sm:justify-start">
                                                    ...
                                                    <Button
                                                        variant="outline"
                                                        size="sm"
                                                        onClick={() => router.push(`/interview-guides/video?moduleId=${module.id}`)}
                    ...
                    <TabsContent value="tips" className="space-y-6">
                        ...
                        <Card className="bg-gradient-to-r from-yellow-50 to-orange-50 dark:from-yellow-950/20 dark:to-orange-950/20 text-card-foreground">
                            <CardHeader>
                            ...
                            <CardContent className="space-y-4">
                                <div className="space-y-3">
                                    <div className="flex items-start space-x-3">
                                        <div className="w-6 h-6 bg-yellow-500 rounded-full flex items-center justify-center text-white text-sm flex-shrink-0">1</div>
                                        <p className="text-sm pt-0.5">Đến sớm 10-15 phút để tạo ấn tượng về tính đúng giờ</p>
                                    </div>
                                    <div className="flex items-start space-x-3">
                                        <div className="w-6 h-6 bg-yellow-500 rounded-full flex items-center justify-center text-white text-sm flex-shrink-0">2</div>
                                        <p className="text-sm pt-0.5">Mang theo nhiều bản CV in để phòng trường hợp phỏng vấn nhóm</p>
                                    </div>
                                    <div className="flex items-start space-x-3">
                                        <div className="w-6 h-6 bg-yellow-500 rounded-full flex items-center justify-center text-white text-sm flex-shrink-0">3</div>
                                        <p className="text-sm pt-0.5">Chuẩn bị 3-5 câu hỏi để hỏi ngược lại nhà tuyển dụng</p>
                                    </div>
                                    <div className="flex items-start space-x-3">
                                        <div className="w-6 h-6 bg-yellow-500 rounded-full flex items-center justify-center text-white text-sm flex-shrink-0">4</div>
                                        <p className="text-sm pt-0.5">Follow up sau phỏng vấn trong vòng 24-48 giờ</p>
                                    </div>
                                </div>
                            </CardContent>
                        </Card>
