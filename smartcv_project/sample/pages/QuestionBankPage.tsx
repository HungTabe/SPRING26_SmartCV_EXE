      ...
      <div className="container px-4 mx-auto py-6">
        ...
        <div className="mb-8">
          <div className="flex items-center space-x-3 mb-4">
            ...
            <div>
              <h1 className="text-4xl">Ngân Hàng Câu Hỏi Phỏng Vấn</h1>
            ...
            <Card key={category.id} className="hover:shadow-md transition-shadow">
              <CardContent className="p-6">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    <div className="text-2xl">{category.count}</div>
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="bg-blue-50 dark:bg-blue-950/20 p-4 rounded-lg">
                        <div className="flex items-start space-x-2">
                          ...
                          <div>
                            <h4 className="text-sm mb-1 text-blue-800 dark:text-blue-200">
                              Gợi ý trả lời:
                            </h4>
            ...
            <Card className="bg-gradient-to-r from-green-50 to-blue-50">
              ...
              <CardContent className="grid md:grid-cols-3 gap-6">
                <div className="text-center">
                  <div className="text-3xl text-green-600 mb-1">45</div>
                  <p className="text-sm text-muted-foreground">Câu đã luyện</p>
                </div>
                <div className="text-center">
                  <div className="text-3xl text-blue-600 mb-1">78%</div>
