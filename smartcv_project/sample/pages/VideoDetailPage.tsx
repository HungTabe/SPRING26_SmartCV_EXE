...
import { PlayCircle, Clock, Users, Star, Download, BookOpen, CheckCircle } from "lucide-react"
  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="container px-4 mx-auto py-6">
        <Breadcrumb 
          items={[
            { label: "Video Hướng Dẫn", page: "home" },
        ...
        <div className="grid lg:grid-cols-3 gap-8 mb-12">
          <div className="lg:col-span-2 space-y-6">
            <div className="space-y-4">
              ...
              <h1 className="text-4xl">{currentIndustry.name}</h1>
            ...
            <Card>
              <CardContent className="p-6">
                ...
                <Button 
                  ...
                  onClick={() => navigateTo('video-player', { industry, videoId: 1 })}
                >
                  Bắt Đầu Học
                </Button>
        ...
        {/* Videos List */}
        <div className="space-y-6">
          <h2 className="text-2xl">Danh Sách Video</h2>
          
          <div className="space-y-4">
            {videos.map((video, index) => (
              <Card key={video.id} className={`transition-all duration-200 ${video.completed ? 'border-green-200 bg-green-50/50' : 'hover:shadow-md'}`}>
                <CardContent className="p-6">
                  <div className="flex items-start space-x-4">
                    <div className="flex-shrink-0">
                      <div className={`w-12 h-12 rounded-lg flex items-center justify-center ${video.completed ? 'bg-green-500 text-white' : 'bg-gray-100'}`}>
                        {video.completed ? (
                    ...
                    <div className="flex-1 space-y-2">
                      <div className="flex items-start justify-between">
                        <div>
                          <h3 className="text-lg mb-1">{video.title}</h3>
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <Button 
                          ...
                          size="sm"
                          onClick={() => navigateTo('video-watch', { videoId: video.id, industry })}
                        >
